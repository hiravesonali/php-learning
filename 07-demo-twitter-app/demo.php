    ...
    <body class="bg-blue-900 h-screen">
        ...
        <div class="flex-shrink-0 flex hover:bg-blue-00 rounded-full p-4 mt-12 mr-2">
          <a href="#" class="flex-shrink-0 group block">
            ...
            <div class="w-3/5 border border-gray-600 h-auto  border-t-0">
                ...
                <div class="flex">
                    ...
                    <div class="flex-1 px-2 pt-2 mt-2">
                        <textarea class=" bg-transparent text-gray-400 font-medium text-lg w-full" name="Text" rows="2" cols="50" placeholder="What's happening?">
                        </textarea>
            ...
            <?php 
            if ($tweetsRs->num_rows > 0) {

                while($tweet = $tweetsRs->fetch_assoc()) {
                    ?>
